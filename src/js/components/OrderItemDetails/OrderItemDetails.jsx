...
import { fetchCurrentOrderDetails } from "../../services/actions/orderItemDetailsActions";
...
const OrderItemDetails = () => {
  ...
  useEffect(() => {
    dispatch(fetchCurrentOrderDetails(id));
  }, [dispatch, id]);
  ...
  return (
    currentOrder && (
      <div className={styles.wrapper}>
        ...
        <p className={`${styles.text_ready} text text_type_main-default mb-15`}>
